...
export default function Article() {
	...
	const articleImage = (article.images && article.images.length > 0)
		? article.images[0]
		: (article.imageUrl || article.image || "https://images.unsplash.com/photo-1529107386315-e1a2ed48a620?auto=format&fit=crop&w=1400&q=85");

	return (
		<article className="mx-auto max-w-4xl px-4 py-16">
			<Helmet>
				<title>{article.title} | Salone News</title>
			...
			<div className="mt-6 flex flex-wrap items-center gap-3">
				...
				<a
					href={getShareUrl('facebook', shareUrl, article.title)}
					target="_blank"
					rel="noopener noreferrer"
				...
				<a
					href={getShareUrl('twitter', shareUrl, article.title)}
					target="_blank"
					rel="noopener noreferrer"
